...
<div class="download-row">
  <a class="download-button" href="https://github.com/Hybrid-Solutions-Cloud/stagecoach/releases/latest/download/Stagecoach-0.6.9-win-x64.msi">
    Download the MSI
  </a>
...
<div class="download-row">
  <a class="download-button" href="https://github.com/Hybrid-Solutions-Cloud/stagecoach/releases/latest/download/Stagecoach-0.6.9-win-x64.zip">
    Download the ZIP
  </a>
</div>
...
```powershell
Get-FileHash .\Stagecoach-0.6.9-win-x64.msi -Algorithm SHA256
# compare against Stagecoach-0.6.9-win-x64.msi.sha256
```
...
cd stagecoach
pwsh ./scripts/Package.ps1 -Version 0.6.9 -Installer
```
